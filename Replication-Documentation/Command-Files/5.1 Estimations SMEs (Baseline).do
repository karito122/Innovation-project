...
esttab cmpc* using "$Output/tables/table_cmp_SMEs.tex", starlevels(* 0.10 ** 0.05 *** 0.01) ///
		replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
		num title({Table 5.1: CDM: Coefficients SMEs}) ///
...
esttab cmpc* using "$Output/tables/table_cmp_SMEs.csv", starlevels(* 0.10 ** 0.05 *** 0.01) ///
		replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
		num title({Table 5.1: Coefficients SMEs}) mtitles("Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall") wrap legend nogaps label ///
		addnotes("Source: Author's elaboration, based on The Spanish Technological innovation panel (PITEC).")

//Simultaneous Estimation: Marginal effects
esttab cmpm* using "$Output/tables/table_ME_SMEs.tex", starlevels(* 0.10 ** 0.05 *** 0.01) ///
		replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
		num title({Table A1: Marginal effects SMEs}) ///
		mtitles("Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall") wrap legend nogaps label ///
		addnotes("Source: Author's elaboration, based on The Spanish Technological innovation panel (PITEC).")

esttab cmpm* using "$Output/tables/table_ME_SMEs.csv", starlevels(* 0.10 ** 0.05 *** 0.01) ///
		replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
		num title({Table A1: Marginal effects SMEs}) mtitles("Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall") wrap legend nogaps label ///
	addnotes("Source: Author's elaboration, based on The Spanish Technological innovation panel (PITEC).")
