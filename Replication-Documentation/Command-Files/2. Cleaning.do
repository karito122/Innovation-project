...
label var newmer_innov "Innovativeness over sales"

/*  
It is convenient to make the description for companies that have a positive 
...
size20 size50 size100 size400 size700 size1000 ln_gtinnpt bsupport_ue ///
support_tot exporter
 { ;
...
global XTLIST1 ln_age ln_age2 ln_size ln_size2 ln_gintidpt depth breadth ////
		...
		uncertainty_barrier ln_researchers parque researchers_ratio ln_support_tot
#delimit ;
