********************************************************************************
********************   6.2 Estimations: Robustness Check I    ******************
...
esttab cProject* using "$Output/tables/table_robustness1_large.tex", starlevels(* 0.10 ** 0.05 *** 0.01) ////
		replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
		num title({Table A4: Coefficients -Large Firms-Robussness I}) ///
...
esttab cProject* using "$Output/tables/table_robustness1_large.csv", starlevels(* 0.10 ** 0.05 *** 0.01) ////
		replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
		num title({Table A4: CDM: Coefficients -Large Firms-Robussness I}) ///
		mtitles("Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall") wrap legend nogaps label ///
		addnotes("Source: Author's elaboration, based on The Spanish Technological innovation panel (PITEC).")
		
//Simultaneous Estimation: Marginal effects (Robustness)
esttab cmpm* using "$Output/tables/table_robustness1_ME_large.tex", starlevels(* 0.10 ** 0.05 *** 0.01) ///
		replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
		num title({Table A4: Marginal effects -Large Firms: Robussness I}) ///
		mtitles("Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall") wrap legend nogaps label ///
		addnotes("Source: Author's elaboration, based on The Spanish Technological innovation panel (PITEC).")

esttab cmpm* using "$Output/tables/table_robustness1_ME_large.csv", starlevels(* 0.10 ** 0.05 *** 0.01) ///
		replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
		num title({Table A4: Marginal effects -Large Firms: Robussness I}) ///
		mtitles("Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall") wrap legend nogaps label ///
		addnotes("Source: Author's elaboration, based on The Spanish Technological innovation panel (PITEC).")
...
//Simultaneous Estimation (Robustness)
esttab cmpr* using "$Output/tables/table_robustness2_large.tex", starlevels(* 0.10 ** 0.05 *** 0.01) ///
	replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
	num title({Table A6: marginal effects -Large Firms (Robustness: Continous Public Support)}) ///
	mtitles("Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall") wrap legend nogaps label ///
	addnotes("Author's elaboration, based on The Spanish Technological innovation panel (PITEC).")

esttab cmpr* using "$Output/tables/table_robustness2_large.csv", starlevels(* 0.10 ** 0.05 *** 0.01) ///
	replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
	num title({Table A6: marginal effects -Large Firms (Robustness: Continous Public Support)}) ///
	mtitles("Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall") wrap legend nogaps label ///
	addnotes("Source: Author's elaboration, based on The Spanish Technological innovation panel (PITEC).")
...
//Simultaneous Estimation: Marginal effects (Robustness)
esttab cmprobma* using "$Output/tables/table_robustness2_ME_large.tex", starlevels(* 0.10 ** 0.05 *** 0.01) ///
	replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
	num title({Table A6: Marginal effects -Large Firms (Robustness: Continous Public Support)}) ///
	mtitles("Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall") wrap legend nogaps label ///
	addnotes("Author's elaboration, based on The Spanish Technological innovation panel (PITEC).")

esttab cmprobma* using "$Output/tables/table_robustness2_ME_large.csv", starlevels(* 0.10 ** 0.05 *** 0.01) ///
	replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
	num title({Table A6: Marginal effects -Large Firms (Robustness: Continous Public Support)}) ///
	mtitles("Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall") wrap legend nogaps label ///
	addnotes("Source: Author's elaboration, based on The Spanish Technological innovation panel (PITEC).")
...
use  "$Output\Panel_filtered_large_all.dta"
set more off
xtset ident year
xtdes
...
esttab cmpc* using "$Output/tables/table_robustness3_large.tex", starlevels(* 0.10 ** 0.05 *** 0.01) ///
		replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
		num title({Table A8: Coefficients Robustness -Large Firms: Sample Selection}) ////
		mtitles("Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall") wrap legend nogaps label ///
		addnotes("Source: Author's elaboration, based on The Spanish Technological innovation panel (PITEC).")

esttab cmpc* using "$Output/table_robustness3_large.csv", starlevels(* 0.10 ** 0.05 *** 0.01) ///
		replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
		num title({Table A8: Coefficients -Large Firms- Robustness: Sample Selection}) ///
		mtitles("Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall") wrap legend nogaps label ///
		addnotes("Source: Author's elaboration, based on The Spanish Technological innovation panel (PITEC).")

//Simultaneous Estimation: Marginal effects
esttab cmpm* using "$Output/table_robustness3_ME_large.tex", starlevels(* 0.10 ** 0.05 *** 0.01) ///
		replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
num title({Table A8: Marginal effects -Large Firms-Robustness: Sample Selection}) ///
		mtitles("Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall") wrap legend nogaps label ///
		addnotes("Source: Author's elaboration, based on The Spanish Technological innovation panel (PITEC).")

esttab cmpm* using "$Output/table_robustness3_ME_large.csv", starlevels(* 0.10 ** 0.05 *** 0.01) ///
		replace b(3) se(3) stat(N N_clust df_m r2_a widstat j jp, fmt(0 0 0 2 3 3 3)) ///
		num title({Table A8: Marginal effects -Large Firms- Robustness: Sample Selection}) ///
		mtitles("Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall" "Failure conception" "Failure Implementation" "Failure overall") wrap legend nogaps label ///
		addnotes("Source: Author's elaboration, based on The Spanish Technological innovation panel (PITEC).")
